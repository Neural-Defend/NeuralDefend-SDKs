...
`neuraldefend-mcp` 1.0.3 is a secure, local Model Context Protocol (MCP) server for
...
Install the published 1.0.3 release:

```bash
python -m pip install "neuraldefend-mcp==1.0.3"
```
